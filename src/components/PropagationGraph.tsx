...
const CustomNode = ({ data }: any) => {
  ...
  return (
    <div className={`px-4 py-2 shadow-xl rounded-lg border-2 ${isOriginal ? 'bg-purple-900/40 border-purple-500' : 'bg-zinc-800 border-zinc-600'} flex flex-col items-center justify-center min-w-[120px]`}>
...
export function PropagationGraph({ data }: GraphProps) {
  ...
  return (
    <div className="w-full h-[500px] border border-white/10 rounded-xl overflow-hidden bg-black/50">
